...
class DBAccessTester extends Component {
  render() {
    const userCreateForm = (
      <UserCreateForm
        endpointResourcePath={`${this.props.baseEndpointResourcePath}/users`}
      />
    );
    const documentCreateForm = (
      <DocumentCreateForm
        endpointResourcePath={`${this.props.baseEndpointResourcePath}/documents`}
      />
    );
    const configCreateForm = (
      <ConfigCreateForm
        endpointResourcePath={`${this.props.baseEndpointResourcePath}/configs`}
      />
    );
