...
prod-push:
	...
	aws s3 cp docker-compose.yml s3://bproject-app-docker-composes/business-logic/docker-compose.yml
	aws s3 cp docker-compose.prod.yml s3://bproject-app-docker-composes/business-logic/docker-compose.prod.yml
